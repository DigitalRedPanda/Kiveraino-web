...
public class URLNotFoundRenderer implements io.jstach.jstachio.Template.EncodedTemplate<com.digiunion.model.URLNotFound>,
    io.jstach.jstachio.context.ContextTemplate<com.digiunion.model.URLNotFound>,
     ...
     * @hidden
     */
    public static final String TEMPLATE_PATH = "template/404.mustache";
     ...
     * @hidden
     */
    public static final String TEMPLATE_NAME = "com.digiunion.model.URLNotFoundRenderer";
     ...
     * @hidden
     */
    public static final Class<?> MODEL_CLASS = com.digiunion.model.URLNotFound.class;

    /**
     * The instance. Use {@link {@link #of()} instead.
     * @hidden
     */
    private static final URLNotFoundRenderer INSTANCE = new URLNotFoundRenderer();
    ...
    @Override
    public StringBuilder execute(com.digiunion.model.URLNotFound model, StringBuilder sb) {
    ...
    public <A extends io.jstach.jstachio.Output<E>, E extends Exception> A execute(
        com.digiunion.model.URLNotFound model, 
        A a) throws E {
    ...
    public java.util.List<io.jstach.jstachio.Template<?>> provideTemplates(io.jstach.jstachio.TemplateConfig templateConfig ) {
        return java.util.List.of(io.jstach.jstachio.TemplateConfig.empty() == templateConfig ? INSTANCE :  new URLNotFoundRenderer(templateConfig));
    }
    ...
    public void process(Object model, io.jstach.jstachio.Output<?> appendable) throws java.lang.Exception {
        execute( (com.digiunion.model.URLNotFound) model, appendable);
    }
     ...
     */
    public URLNotFoundRenderer(io.jstach.jstachio.TemplateConfig templateConfig) {
     ...
     */
    public static URLNotFoundRenderer of() {
        return INSTANCE;
    }
    ...
    public static <A extends io.jstach.jstachio.Output<E>, E extends Exception> void render(
        com.digiunion.model.URLNotFound data, 
        A unescapedWriter,
        io.jstach.jstachio.Formatter formatter,
    ...
    protected static <A extends io.jstach.jstachio.Output<E>, E extends Exception> void render(
        com.digiunion.model.URLNotFoundRenderer template, 
        com.digiunion.model.URLNotFound data, 
        io.jstach.jstachio.context.ContextNode context, 
        A unescapedWriter,
        io.jstach.jstachio.Formatter formatter,
